...
const Sweepstakes = () => {
    ...
    if (activeLang === 'int') {
        tiktokUrl = 'https://www.tiktok.com/@coco_and_eve_sg?lang=en';
    } else if (activeLang === 'my') {
        tiktokUrl = 'https://www.tiktok.com/@coco_and_eve_my?lang=en';
    }
                    ...
                    <div class="row m-0 align-items-center justify-content-end">
                        <div class="px-g col-lg-5 order-lg-1 my-lg-4 mt-n5">
                            ...
                            <div className='social-icon d-flex justify-content-center mt-4'>
                                ...
                                <a className='mx-1' href={tiktokUrl} target="_blank">

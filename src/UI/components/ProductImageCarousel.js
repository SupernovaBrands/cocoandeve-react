...
const ProductImageCarousel = () => {
    ...
    return (
        <Fragment>
            ...
            <div id="product-image-carousel__indicator" className="d-none d-lg-block product-image-carousel__indicator carousel--swipe col-12 col-lg-1 order-lg-1 carousel slide carousel--loop mb-1 mb-lg-0 px-0 px-lg-g" data-bs-slide-number="5" data-bs-ride="carousel" >
                ...
                <div className="carousel-inner d-flex flex-nowrap flex-lg-column justify-content-center justify-content-lg-start">
                    {PRODUCT_IMAGES.map((image, index) => (
                    <div data-bs-target="#product-image-carousel" data-bs-slide-to={index} className="product-image-carousel__indicator__item carousel-item active col-12 px-lg-0 pb-lg-3 mw-100">

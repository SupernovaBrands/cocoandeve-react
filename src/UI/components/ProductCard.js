		...
		<div className={`carousel-item col-9 col-md-3 product-card text-center ${props.classname}`}>
			...
			<div className='pt-2 pb-0 position-relative flex-grow-1 d-flex flex-column px-3'>
				...
				<p className="product-card__title flex-grow-1 d-flex flex-column justify-content-center h4 h-100 mb-0 fw-normal">
    				<a href="/products/sunny-honey-bali-bronzing-self-tan-mousse" className="text-dark text-decoration-none">{props.title}</a>
  				</p>
				<p className="text-center">
      				<span className="text-linethrough h4 m-1 font-weight-normal">$96.80</span>
    				<span className="text-primary h4">$59.90</span>
  				</p>

...
const SingleChoiceIcon = (props) => {
    ...
    const defaultSelected = currentAnswer && currentAnswer[currentQuestion] ? currentAnswer[currentQuestion] : answers.at(0);
        ...
        <div className='col-12 col-lg-10 single-choice single-choice--icon d-flex flex-wrap justify-content-center p-lg-0'>
            {
                ...
                width > 991 && answers.map((item,index) => {
            ...
            {
                width < 992 && answers.map((answer, index) => {

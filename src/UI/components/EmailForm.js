...
const EmailForm = (props) => {
    ...
    return (
        <div className="col-12 col-lg-6 mt-4 pt-0 pt-lg-4 text-center">
            ...
            <a href="#" className="d-block text-underline text-primary w-100 mt-2 mb-lg-4" onClick={viewMyResult}>I don't want 15% off. Skip this step ></a>
            ...
            <div className="footer-action w-100 pb-2 bg-white mt-2"></div>
        </div>
    )
};

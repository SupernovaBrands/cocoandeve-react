		...
		<div className="accordion accordion-flush youth-revive__accordion-panel" id="accordionReviveBannerReverse">
			<div className="accordion-item border-0">
				...
				<div id="collapseOne" className="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionReviveBannerReverse">
					<div className="accordion-body youth-revive__banner-text-desc mb-2 mb-lg-2 p-0">
					Apply a small amount of our Seed Oil Cleanser onto your <br className="d-none d-lg-block" />face with your hands before massaging into the skin in a <br className="d-none d-lg-block" />circular motion. When your makeup and other impurities <br className="d-none d-lg-block" />have dissolved in the formula, rinse off with lukewarm <br className="d-none d-lg-block" />water.
					</div>
				</div>
			</div>
			<div className="accordion-item border-0">
			...
			<div className="row youth-revive__banner-text skincare__banner-text-reverse align-items-lg-center">
				<div className="col-12 col-lg-6 px-2 px-lg-g pe-lg-0 youth-revive__banner-text-content youth-revive__banner-text-reverse-content">
					<div className="youth-revive__banner-text-wrapper youth-revive__banner-text-reverse-wrapper pt-3 pb-1 py-lg-0 pe-lg-g">
						<p className="youth-revive__banner-text-reverse-title fw-bold d-none d-lg-block mb-4 mt-2">Meet your new<br className="d-none d-lg-block" />'glow-to' daily<br className="d-none d-lg-block" />routine</p>

...
const RangeCarousel = () => {
	...
	return (
		<section className='range__carousel py-4'>
			<ul class="nav nav-tabs mx-auto nav-tabs--product text-center mb-2 justify-content-center" role="tablist">
				<li class="nav-item">
					<a class="nav-link text-decoration-none h4 mb-0 font-weight-normal" data-bs-toggle="tab" href="#new" role="tab" aria-controls="new">New</a>
				</li>
				<li class="nav-item">
					<a class="nav-link text-decoration-none h4 mb-0 font-weight-normal active" data-bs-toggle="tab" href="#bestsellers" role="tab" aria-controls="bestsellers">Bestsellers</a>
				</li>
				<li class="nav-item">
					<a class="nav-link text-decoration-none h4 mb-0 font-weight-normal" data-bs-toggle="tab" href="#value-sets" role="tab" aria-controls="value-sets">Value Sets</a>
				</li>
			</ul>
            <div className='tab-content container px-sm-0 px-md-2 text-center'>
				...
				<div className='tab-pane fade carousel slide carousel--loop show active' id='bestsellers' role='tabpanel' data-bs-ride='carousel' data-bs-interval='false' aria-labelledby='bestsellers-tab' data-bs-slide-number='4'>
					...
					<button class="carousel-control carousel-control-next carousel-control--background floating-out-right justify-content-end text-primary" data-bs-target="#bestsellers" data-bs-slide="next">

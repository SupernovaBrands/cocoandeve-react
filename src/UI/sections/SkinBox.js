...
const ReviveBannerReverse = () => {
	return (
		<section className="youth-revive__section skincare__banner-text-reverse-wrapper skincare__banner px-g">
			<p className="youth-revive__banner-text-reverse-title fw-bold d-lg-block mb-3 youth-revive__reviews">So, what activates your glow?</p>

...
const ReviveBannerReverse = () => {
	return (
		<section className="youth-revive__section skincare__banner-text-reverse-wrapper skincare__banner pb-4">
			<p className="youth-revive__banner-text-reverse-title fw-bold d-lg-block mb-3 youth-revive__reviews mt-2">So, what activates your glow?</p>

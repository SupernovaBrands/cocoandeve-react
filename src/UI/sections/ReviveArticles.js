const ARTICLES = [
	{
		...
		src: 'https://imagedelivery.net/ghVX8djKS3R8-n0oGeWHEA/1a4dd32e-dfb5-4ad9-cef5-2a5e5db9e400/726x',
	...
	},
	{
		...
		src: 'https://imagedelivery.net/ghVX8djKS3R8-n0oGeWHEA/e6cb5f0d-952b-47ba-5de2-97a488d02500/726x',
	...
	},
	{
		...
		src: 'https://imagedelivery.net/ghVX8djKS3R8-n0oGeWHEA/4db6c866-a174-4006-fa68-41305fb3da00/726x',
...
const ArticleCard = (props) => {
	return (
		<figure className={`col-12 ${props.data.className} position-relative mb-3`}>
			<picture className="d-block">
				<source srcSet={`${props.data.srcSet}`} media="(min-width: 992px)"/>
				<img className="w-100" src={props.data.src} alt={props.data.title} />
			</picture>
			<figcaption>

            ...
            reviews: [
                {
                    ...
                    shade: '',
                    text: "<p>Best!</p><p>I love it, my hair really needed some love ! After using it for a few weeks now my hair is now nice and shiny and looks and feels healthy. I now wear my hair down more often ! Also, my order was processed really quickly making this a very good experience :)</p>",
                },
                {
                    name: 'Samantha L. Verified Buyer',
                    shade: '',
                    text: "<p>Super soft and smells amazing!</p><p>I have very thick, curly hair that has been dyed so as you can imagine that’s the perfect recipe for very dry hair. Since using this hair mask my hair is so much softer and shinier! It smells amazing too! Highly recommended for anyone with dry, thick, curly hair like me!</p>",
                },
                {
                    name: 'Pryncess H. Verified Buyer',
                    shade: 'Shade of Tan: Dark',
                    text: "<p>Hair Concern:Dryness</p><p>I’m absolutely in love with these products. Not only does it make my hair look and feel great but the smell is absolutely amazing! I have already re-ordered three times and will continue to do so.</p>",
                },
                {
                    name: 'Yelena A. Verified Buyer',
                    shade: '',
                    text: "<p>Smells gorgeous</p><p>Smells gorgeous, has made my hair shinier and bouncier. I personally prefer leaving it in after conditioning that way it soaks into my hair and keeps it soft.</p>",
                },
                {
                    name: 'Andy D. Verified Buyer',
                    shade: '',
                    text: "<p>In love with this hair masque!</p><p>This is the best hair masque I've ever tried. It was so easy to detangle my hair after applying it and my hair has been soft, bouncy, and super hydrated. For the elixir, a little product goes a long way and as described: wonderful for heat protection, hydration, and styling.",
                },
                {
                    name: 'Jeyanthy J. Verified Buyer',
                    shade: '',
                    text: "<p>Best ever</p><p>Been using this product for past 3 months and there is huge changes. I am pleased to say my hair is shiny and softer. Definitely purchase this product again. Also safe to use as this is a clean product. Such a worth buy to do treatment many times at home.</p>",
                },
                {
                    name: 'Katie D. Verified Buyer',
                    shade: '',
                    text: "<p>My hair made a come back</p><p>I am obsessed, my frizz is near non-existent and my waves have made a return. I had lost confidence by having damaged hair but since using like a virgin, I have the confidence to let other people touch and admire My hair. I used to think hair masks were just another money making scam and that’s conditioners job anyways, boy was I wrong.</p>",
                },
            ],
        },
        fr: {
            ...
            reviews: [
                {
                    name: 'Bianca I. Verified Buyer',
                    shade: '',
                    text: "<p>Das beste Produkt!</p><p>Ich liebe es, meine Haare brauchten wirklich etwas Liebe! Nachdem ich es ein paar Wochen lang verwendet habe, sind meine Haare jetzt schön und glänzend , sehen gesund aus und fühlen sich auch so an. Ich trage meine Haare jetzt öfter offen! Außerdem wurde meine Bestellung super schnell bearbeitet, also war es eine insgesamt sehr gute Erfahrung :)</p>",
                },
                {
                    name: 'Samantha L. Verified Buyer',
                    shade: '',
                    text: "<p>Super weich und duftet fantastisch!</p><p>Ich habe sehr dickes, lockiges Haar, das gefärbt wurde, daher waren meine Ergebnisse, wie du dir vorstellen kannst, immer sehr trocken. Seit ich diese Haarmaske verwende, sind meine Haare so viel weicher und glänzender! Sie riecht auch sehr gut! Definitiv empfehlenswert für alle mit trockenem, dickem und lockigem Haar wie mir!</p>",
                },
                {
                    name: 'Pryncess H. Verified Buyer',
                    shade: '',
                    text: "<p>Haarprobleme: Trockenheit</p><p>Ich bin absolut verliebt in diese Produkte. Mein Haar sieht nicht nur toll aus und fühlt sich auch so an, es riecht absolut fantastisch! Ich habe bereits dreimal nachbestellt und werde dies auch weiterhin tun.</p>",
                },
                {
                    name: 'Yelena A. Verified Buyer',
                    shade: '',
                    text: "<p>Fantastischer Geruch</p><p>Der Duft ist fantastisch, meine Haare sind glänzender und weicher. Ich persönlich lasse die Haarmaske lieber nach der Spülung einwirken, damit es in mein Haar einzieht und es geschmeidig hält.</p>",
                },
                {
                    name: 'Andy D. Verified Buyer',
                    shade: '',
                    text: "<p>Ich liebe diese Haarmaske!</p><p>Das ist die beste Haarmaske, die ich je probiert habe. Es war super einfach, mein Haar nach dem Auftragen zu entwirren und mein Haar fühlte sich weich, voluminös und super hydratisiert an. Für das Elixier reicht schon eine kleine Menge Produkt und wie beschrieben: Wunderbar für Hitzeschutz, Feuchtigkeit und Styling. ",
                },
                {
                    name: 'Jeyanthy J. Verified Buyer',
                    shade: '',
                    text: "<p>Das Beste aller Zeiten</p><p>Ich benutze dieses Produkt seit 3 Monaten und die Veränderungen sind enorm. Ich freue mich sagen zu können, dass mein Haar glänzender und weicher ist. Ich werde dieses Produkt auf jeden Fall nachkaufen. Es ist auch sicher in der Anwendung, da es sich um ein Produkt ohne ungesunde Chemikalien handelt. Eine Anschaffung die sich lohnt, um deine Haare professionell zu Hause zu pflegen.</p>",
                },
                {
                    name: 'Katie D. Verified Buyer',
                    shade: '',
                    text: "<p>Meine Haare sind wieder nachgewachsen</p><p>Ich bin total überzeugt, mein Frizz ist fast nicht mehr vorhanden und meine Wellen sind zurück. Ich hatte mein Selbstvertrauen verloren, weil ich so kaputtes Haar hatte, aber seit ich die Like A Virgin-Reihe verwende und Leute mein Haare bewundern, fühle ich mich wieder stark. Ich dachte, Haarmasken seien nur ein weiterer Betrug und Conditioner wären viel besser, aber ich habe mich geirrt.</p>",
                },
            ],
        }
    }

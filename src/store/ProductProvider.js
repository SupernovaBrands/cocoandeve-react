...
const _content = {
    ...
    "deep-condition-bundle": {
        us: {
            ...
            stars: '4.8',
            benefits: {
                formula1: 'Super Hydrating Shampoo moisturises and cleanses hair without stripping colour.',
                formula2: 'Super Hydrating Cream Conditioner deeply conditions resulting in visibly glossier, shinier & smoother hair.',
        ...
        fr: {
            ...
            stars: '4.8',
            benefits: {
                formula1: 'Shampoing super hydratant qui hydrate et nettoie les cheveux sans décaper la couleur.',
        ...
        de: {
            ...
            stars: '4.8',
            benefits: {
                formula1: 'Super Pflegendes Shampoo pflegt und reinigt dein Haar ohne auszutrocknen oder ihm Farbglanz zu entziehen.',
                formula2: 'Intensiv Pflegender Conditioner mit sofortigem Feuchtigkeitsboost für sichtbar glänzendes, geschmeidiges Haar.',
    ...
    "repairing-restoring-hair-mask": {
        us: {
            ...
            stars: '4.8',
            benefits: {
                formula1: 'Scientifically formulated to deeply repair and restore in just 5 minutes!',
                formula2: 'Hair repair powerblend of active ingredients: Biomimetic Ceramides, Vegan Keratin Complex and Hyaluronic Acid reduce hair damage and repair hair weakened by heat, chemical damage and color.',
                formula3: 'Hair is completely restored and cracks are repaired from first use for healthier, smoother, softer hair.',
                formula4: 'Clinically proven: improves hair strength by 85% and reduces damage by up to 65%.',
            },
            asSeenin: 'As seen in',
            atc: 'Add to cart',
            shades: []
        ...
        fr: {
            ...
            stars: '4.8',
            benefits: {
                formula1: 'Formulé scientifiquement pour réparer et redonner vie à tes cheveux en seulement 5 minutes !',
                formula2: 'Un mélange puissant de principes actifs pour réparer les cheveux : les céramides biomimétiques, le complexe de kératine vegan et l`acide hyaluronique réduisent les dommages et réparent les cheveux affaiblis par la chaleur, les produits chimiques et les colorations.',
                ...
                formula4: 'Cliniquement prouvé : améliore la résistance des cheveux de 85% et réduit les dommages jusqu`à 65%.',
            },
            asSeenin: 'Comme on peut le voir dans',
            atc: 'Ajouter au panier',
            shades: []
        ...
        de: {
            ...
            stars: '4.8',
            benefits: {
                formula1: 'Wissenschaftlich formuliert, um in nur 5 Minuten tiefgreifend zu reparieren und wiederherzustellen!',
                formula2: 'Haarreparatur-Power-Mischung aus Wirkstoffen: Biomimetische Ceramide, veganer Keratin-Komplex und Hyaluronsäure reduzieren Haarschäden und reparieren geschwächtes Haar.',
    ...
    "shampoo-conditioner-set": {
        us: {
            ...
            benefits: {
                ...
                formula3: '7-in-1 formula for instant hydration, shine, softness, strength, volume & no split ends or frizz. Suitable for normal to dry hair.',
        ...
        fr: {
            ...
            benefits: {
                ...
                formula3: 'Formule 7 en 1 qui hydrate et adoucit les cheveux tout en prévenant les fourches et en domptant les frisottis. Pour une brillance et un volume instantanés.',
    ...
    "super-nourishing-coconut-fig-hair-masque": {
        us: {
            ...
            stars: '4.8',
            benefits: {
                formula1: '5 in 1 treatment.',
                formula2: 'Restores dry damaged hair.',
                formula3: 'Improves hair texture and shine.',
                formula4: 'Hydrates and deeply conditions.',
                formula5: 'Treats split ends and tames frizz.',
                formula6: 'Transform your hair in only 10 minutes.',
            },
            asSeenin: 'As seen in',
            atc: 'Add to cart',
            shades: []
        ...
        fr: {
            ...
            stars: '4.8',
            benefits: {
                formula1: 'Soin 5 en 1.',
                formula2: 'Répare les cheveux secs et abimés.',
                formula3: 'Améliore la texture et redonne de l`éclat aux cheveux.',
                formula4: 'Hydrate et nourrit des longueurs jusqu`aux pointes.',
                formula5: 'Prévient les fourches et dompte les frisottis.',
                formula6: 'Transforme tes cheveux en seulement 10 minutes.',
            },
            asSeenin: 'Comme on peut le voir dans',
            atc: 'Ajouter au panier',
            shades: []
        ...
        de: {
            ...
            stars: '4.8',
            benefits: {
                formula1: '5-in-1-Behandlung.',
                formula2: 'Repariert trockenes und geschädigtes Haar.',
                formula3: 'Verbessert die Haarstruktur und verleiht einen wunderschönen Glanz.',
                formula4: 'Spendet Feuchtigkeit und pflegt bis in die Spitzen.',
                formula5: 'Behandelt Spliss und zähmt krauses Haar.',
                formula6: 'Verwandelt dein Haar in nur 10 Minuten.',
            },
            asSeenin: 'Empfohlen von',
            atc: 'Jetzt kaufen',
            shades: []
